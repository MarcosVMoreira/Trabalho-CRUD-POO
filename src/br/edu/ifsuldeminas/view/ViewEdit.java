...
import br.edu.ifsuldeminas.controller.ControllerEdit;
...
public class ViewEdit extends javax.swing.JFrame {
     ...
     */
    ControllerEdit controllerEdit = new ControllerEdit();
    ViewCustomerList viewCustomerList = new ViewCustomerList();
    JTable tabela;

    ViewEdit(JTable tbCustomerTable) {
        tabela = tbCustomerTable;
        initComponents();
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        validateFields();
        viewCustomerList.clearTable(tabela);
        viewCustomerList.addRowToJTable(tabela);
    ...
    private void btnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExitActionPerformed
        viewCustomerList.clearTable();
        viewCustomerList.addRowToJTable();
        this.dispose();
    ...
    private void validateFields() {
        ...
        if ("".equals(txtName.getText()) || "".equals(txtAdress.getText())
            ...
            if (cont != 1) {
                ...
                controllerEdit.saveEdit(Integer.parseInt(txtId.getText()), txtName.getText(), txtAdress.getText(), txtDistrict.getText(),
...
//                        txtCity.getText(), txtState.getText(), txtCEP.getText(), gender, txtCellphoneNumber.getText(),
//                        txtTelephoneNumber.getText(), txtEmail.getText(), txtBirthday.getText(), txtRegisterdate.getText());
                JOptionPane.showMessageDialog(this, "Alteraçoes realizadas com suceso com sucesso.");
    ...
    public void populateFields(int i) {
        txtId.setText(Integer.toString(ControllerCliente.customers.get(i).getId()));
        txtName.setText(ControllerCliente.customers.get(i).getName());
        txtAdress.setText(ControllerCliente.customers.get(i).getAdress());
        txtDistrict.setText(ControllerCliente.customers.get(i).getDistrict());
        txtCity.setText(ControllerCliente.customers.get(i).getCity());
        txtState.setText(ControllerCliente.customers.get(i).getState());
        txtCEP.setText(ControllerCliente.customers.get(i).getCep());
        txtCellphoneNumber.setText(ControllerCliente.customers.get(i).getCellphoneNumber());
        txtTelephoneNumber.setText(ControllerCliente.customers.get(i).getTelephoneNumber());
        txtBirthday.setText(ControllerCliente.customers.get(i).getBirthday());
        txtRegisterdate.setText(ControllerCliente.customers.get(i).getRegisterDate());
        txtEmail.setText(ControllerCliente.customers.get(i).getEmail());

        if ("male".equals(ControllerCliente.customers.get(i).getGender())) {
